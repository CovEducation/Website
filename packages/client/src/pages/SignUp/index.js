...
const SignUpPage = (props) => {
  ...
  const ThirdPage = () => {
    ...
    const showRemoveChildButton =
      parentWizardSignUpData.registeredChildren.length > 1;
      ...
      <div>
        ...
        <ChildSignUpButtonWrapper>
          ...
          {showRemoveChildButton ? (
            <Button onClick={handleRemoveClick}>Remove Child</Button>
          ) : null}
        </ChildSignUpButtonWrapper>
      </div>
    );
